...
exports.handler = async () => {
  const scriptUrl =
    'https://catchup.acdsolutions.it/jstag/videoplayerLiveFluid/TV?ch=0&eID=livePlayerPageElement&vID=9999999999999&autoPlay=true';
  ...
  try {
    ...
    if (!match) {
      return {
        ...
        body: JSON.stringify({
          live: false,
          message: 'No stream URL found in San Marino RTV player script',
        }),
      };
    }
